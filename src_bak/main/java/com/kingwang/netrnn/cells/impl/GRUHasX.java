...
public class GRUHasX extends Operator implements Cell, Serializable{
    ...
    public GRUHasX(int inDynSize, int inFixedSize, int outSize, MatIniter initer) {
    ...
    public void bptt(Map<String, DoubleMatrix> acts, int lastT, Cell... cell) {
    	...
    	AttentionHasX att = (AttentionHasX)cell[0];
