 ...
 * @version 1.0
 */
public class InputLayerHasXAndCOut extends Operator implements Cell, Serializable {
    ...
    public InputLayerHasXAndCOut(int codeSize, int inDynSize, MatIniter initer) {
    ...
    public InputLayerHasXAndCOut(DoubleMatrix Wx) {
    	this.Wx = Wx;
