...
public class GRU extends Operator implements Cell, Serializable{
    ...
    public GRU(int inDynSize, int inFixedSize, int outSize, MatIniter initer) {
    ...
    public void bptt(Map<String, DoubleMatrix> acts, int lastT, Cell... cell) {
    	...
    	Attention att = (Attention)cell[0];
