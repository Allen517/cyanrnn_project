 ...
 * @version 1.0
 */
public class InputLayerHasCOut extends Operator implements Cell, Serializable {
    ...
    public InputLayerHasCOut(int codeSize, int inDynSize, MatIniter initer) {
    ...
    public InputLayerHasCOut(DoubleMatrix Wx) {
    	this.Wx = Wx;
