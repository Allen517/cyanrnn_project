 ...
 */
package com.kingwang.netrnn.cons;
...
public class AlgConsHSoftmax {
	...
	public static int[] nodeSizeInCls = null;
	
	//node size
	public static int nodeSize = 0;
	//in input layer, the size of dynamic input 
	public static int inDynSize = 0;
	//in input layer, the size of representation 
	public static int inRepSize = 0;
