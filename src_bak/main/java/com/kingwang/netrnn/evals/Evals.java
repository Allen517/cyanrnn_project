...
public class Evals {
    ...
    static GRU gru;
    static Attention att;
    static OutputLayer output;
	
    @Deprecated
	public static void testOnMRR(InputLayer input, GRU gru, Attention att, OutputLayer output
...
//            		System.out.println("Missing node"+curNd);
	...
	public static void main(String[] args) {
        ...
        att = new Attention(AlgConsHSoftmax.hiddenSize, initer);
