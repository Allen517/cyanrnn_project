 ...
 * @version 1.0
 */
public class OutputLayerWithOnlyTime extends Operator implements Cell, Serializable {
...
//    public DoubleMatrix hd2bc;
    ...
    public OutputLayerWithOnlyTime(int inDynSize, int inFixedSize, int attSize, int hiddenSize
...
//    	acts.put("dbc", dbc);
    ...
    public void updateParametersByAdaGrad(BatchDerivative derv, double lr) {
    	...
    	OutputBatchWithOnlyTimeDerivative batchDerv = (OutputBatchWithOnlyTimeDerivative) derv;
