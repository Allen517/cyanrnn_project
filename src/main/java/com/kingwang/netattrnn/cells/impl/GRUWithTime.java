...
public class GRUWithTime extends Operator implements Cell, Serializable{
    ...
    public GRUWithTime(int inDynSize, int inFixedSize, int outSize, MatIniter initer) {
    ...
    public void bptt(Map<String, DoubleMatrix> acts, int lastT, Cell... cell) {
    	...
    	AttentionWithTime att = (AttentionWithTime)cell[0];
