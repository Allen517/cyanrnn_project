...
public class GRUWithCov_bak extends Operator implements Cell, Serializable{
    ...
    public GRUWithCov_bak(int inDynSize, int inFixedSize, int outSize, MatIniter initer) {
