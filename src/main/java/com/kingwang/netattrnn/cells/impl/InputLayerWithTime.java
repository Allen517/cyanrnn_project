 ...
 * @version 1.0
 */
public class InputLayerWithTime extends Operator implements Cell, Serializable {
    ...
    public InputLayerWithTime(int codeSize, int inDynSize, MatIniter initer) {
    ...
    public InputLayerWithTime(DoubleMatrix Wx) {
    	this.Wx = Wx;
    ...
    public void bptt(Map<String, DoubleMatrix> acts, int lastT, Cell... cell) {
    	...
    	OutputLayerWithTime outLayer = (OutputLayerWithTime) cell[0];
    	AttentionWithTime att = (AttentionWithTime) cell[1];
    	GRUWithTime gru = (GRUWithTime)cell[2];
