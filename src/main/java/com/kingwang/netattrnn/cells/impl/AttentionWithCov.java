 ...
 * @version 1.0
 */
public class AttentionWithCov extends Operator implements Cell, Serializable {
	...
	public AttentionWithCov(int inDynSize, int inFixedSize, int attSize, int hiddenSize
