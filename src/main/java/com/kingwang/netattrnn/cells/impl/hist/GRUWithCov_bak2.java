...
public class GRUWithCov_bak2 extends Operator implements Cell, Serializable{
    ...
    public GRUWithCov_bak2(int inDynSize, int inFixedSize, int outSize, MatIniter initer) {
        ...
        for (int t = lastT; t > -1; t--) {
            ...
            for(int k=t; k<maxSize; k++) {
            	...
            	if(deltaGV!=null) {
            		...
            		deltaH = deltaH.add(deltaGVevV.getRow(t-bsIdx).mmul(cov.Whv.transpose()));
            	}
            }
