 ...
 * @version 1.0
 */
public class InputLayerWithOnlyTime extends Operator implements Cell, Serializable {
    ...
    public InputLayerWithOnlyTime(int codeSize, int inDynSize, MatIniter initer) {
    ...
    public InputLayerWithOnlyTime(DoubleMatrix Wx) {
    	this.Wx = Wx;
    ...
    public void bptt(Map<String, DoubleMatrix> acts, int lastT, Cell... cell) {
    	...
    	AttentionWithOnlyTime att = (AttentionWithOnlyTime) cell[1];
    	GRUWithOnlyTime gru = (GRUWithOnlyTime)cell[2];
