 ...
 * @version 1.0
 */
public class InputLayer_alphaReg extends Operator implements Cell, Serializable {
    ...
    public InputLayer_alphaReg(int codeSize, int inDynSize, MatIniter initer) {
    ...
    public InputLayer_alphaReg(DoubleMatrix Wx) {
    	this.Wx = Wx;
    ...
    public void bptt(Map<String, DoubleMatrix> acts, int lastT, Cell... cell) {
    	...
    	Attention_alphaReg att = (Attention_alphaReg) cell[1];
    	GRU gru = (GRU)cell[2];
