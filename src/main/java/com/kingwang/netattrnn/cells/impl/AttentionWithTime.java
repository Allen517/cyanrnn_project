 ...
 * @version 1.0
 */
public class AttentionWithTime extends Operator implements Cell, Serializable {
	...
	public AttentionWithTime(int inDynSize, int inFixedSize, int attSize, int hiddenSize
