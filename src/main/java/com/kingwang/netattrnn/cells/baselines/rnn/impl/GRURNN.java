...
public class GRURNN extends Operator implements Cell, Serializable{
    ...
    public GRURNN(int inDynSize, int inFixedSize, int outSize, MatIniter initer) {
    ...
    public void bptt(Map<String, DoubleMatrix> acts, int lastT, Cell... cell) {
    	...
    	OutputLayerRNNWithHS outLayer = (OutputLayerRNNWithHS)cell[0];
        ...
        for (int t = lastT; t > -1; t--) {
            ...
            DoubleMatrix deltaH = deltaY.mmul(outLayer.Wsy[cidx].transpose())
