 ...
 * @version 1.0
 */
public class InputLayerRNN extends Operator implements Cell, Serializable {
    ...
    public InputLayerRNN(int codeSize, int inDynSize, MatIniter initer) {
    ...
    public InputLayerRNN(DoubleMatrix Wx) {
    	this.Wx = Wx;
