...
public class GRUWithHSoftmaxTest {
	...
	public void setCell() {
		...
		AlgConsHSoftmax.lambda_alpha = .5;
		input = new InputLayer(nodeSize, inDynSize, new MatIniter(Type.Test, 0, 0, 0));
        att = new Attention(inDynSize, inFixedSize, outSize, outoutSize, new MatIniter(Type.Test, 0, 0, 0));
...
//		nodeVec.put(1, x);
		...
		att = new Attention(inDynSize, inFixedSize, outSize, outoutSize, initer);
